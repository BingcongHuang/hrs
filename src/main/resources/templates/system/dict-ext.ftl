                            ...
                            <form class="layui-form" style="padding-top: 1rem;margin-left:0px">
                                <div class="layui-form-item">
                                    <div class="layui-inline">
                                        <label class="layui-form-label" style="padding: 8px">Key：</label>
                                        <div class="layui-input-inline">
                                            <input class="layui-input" placeholder="Key" id="s_commonkey"
                                                   name="s_commonkey"
                                                   value="">
                                        </div>
                                    </div>
    ...
    layui.use(['table', 'form', 'admin'], function () {
        ...
        active = {
            ...
            create: function (othis) {
                ...
                //admin.openRight(500, '${mainDomain}/cloud/sysDictExt/toSave?id=' + id);
                var index = layer.open({
                    type: 2,
                    title: "",
                    content: '${mainDomain}/cloud/sysDictExt/toSave?id=' + id,
                    area: ['500px', '500px']
                });
            },
            // 删除
            delById: function (othis) {
                ...
                layer.confirm('确认要删除吗？', function (index) {
                    ...
                    idList.push(id);
                    //发异步删除数据
                    layui.jquery.post("${mainDomain}/cloud/sysDictExt/delete", "idList="+idList, function (res) {
                        if (res.code == 0 ) {
                            laytable.reload('testReload');
        ...
        laytable.render({
            elem: '#userinfo',
            url: '${mainDomain}/cloud/sysDictExt/selectAllPg',
            method: 'post',
            where: {},
            loading: true,
            cellMinWidth: 80,
            ...
            cols: [[
                {field: 'commonkey', title: 'key'}
                , {field: 'lvalue', title: 'value'}
