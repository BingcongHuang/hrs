;layui.define(["setter", "view"], function (e) {
    var a = layui.jquery, t = layui.laytpl, i = layui.element, n = layui.setter, l = layui.view, s = layui.device(),
        ...
        g = "layadmin-side-shrink", x = "LAY-templates.system-side-menu", C = {
            ...
            openRight:function(width,url,e){
                var index = layer.open(a.extend({
                    type: 2,
                    id: "LAY_adminPopupR_open",
                    anim: -1,
                    title: !1,
                    closeBtn: !1,
                    offset: "r",
                    shade: .1,
                    shadeClose: !0,
                    skin: "layui-anim layui-anim-rl layui-layer-adminRight-CP ",
                    area: width+"px",
                    content:url
                }, e))
            },
            ...
            flexible: function (e) {
                ...
                C.popupRight({
                    id: "LAY_adminPopupAbout", success: function () {
                        l(this.id).render("templates.system/about")
                    }
                })
            }, more: function () {
                C.popupRight({
                ...
                var t = "LAY-templates.system-pagetabs-remove";
    ...
    }), i.on("nav(layadmin-templates.system-side-menu)", function (e) {
