layui.config({
    base: mainDomain+'/cloud/static/layui/'      //自定义layui组件的目录
}).extend({setter: "config", admin: "admin", view: "view"}).define(["setter", "admin"], function (e) {
    var a = layui.setter, n = layui.element, i = layui.admin, t = i.tabsPage, l = layui.view, o = function () {
        ...
        return "tab" === t.type && ("/" !== y || "/" === y && i.tabsBody().html()) ? (i.tabsBodyChange(t.index), h(t.type)) : (l().render(r.join("/")).then(function (l) {
            ...
            r.each(function (e) {
                ...
                n === y && (o = !0, t.index = e)
            }), a.pageTabs && "/" !== y && (o || final(d(s).append('<div class="layadmin-tabsbody-item layui-show"></div>'), t.index = r.length, n.tabAdd(u, {
    ...
    layui.link(a.base + "admin.css?v=" + (i.v + "-1"), function () {
        r()
    ...
    function popupRight(){
        return l.popup.index = layer.open(d.extend({
            type: 1,
            id: "LAY_adminPopupR",
            anim: -1,
            title: !1,
