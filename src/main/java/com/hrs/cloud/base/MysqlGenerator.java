...
public class MysqlGenerator {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = "G:\\ideaworkspace\\hrs";
        gc.setOutputDir(projectPath + "/src/main/java");
        gc.setAuthor("bingcong huang");
        gc.setOpen(false);
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/hrs?useSSL=false&serverTimezone=Asia/Shanghai");
        ...
        pc.setParent(null);
        // 这个地址是生成的配置文件的包路径
        pc.setEntity("com.hrs.cloud.entity");

        //pc.setController("com.cikers.ps.controller");
//        pc.setService("com.hrs.cloud.service");
        pc.setMapper("com.hrs.cloud.dao");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输出文件名
                return projectPath + "/src/main/java/com/hrs/cloud/dao/mapper"
